...
#     print(faces)
#     cropped_image_path = None  # initialize to None
#     for (x, y, w, h) in faces:
#         cropped_image = image_array[y:y + h, x:x + w]
#         original_image_name = os.path.splitext(os.path.basename(image_path))[0]
#         cropped_image_path = original_image_name + "_cropped"
#         cropped_image = cv2.cvtColor(cropped_image, cv2.COLOR_BGR2RGB)  # convert back to RGB
