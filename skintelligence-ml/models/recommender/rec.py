...
# conn = sqlite3.connect('/Users/kavyashrivastava/PycharmProjects/backend/skintelligence.db')
# cursor = conn.cursor()
# cursor.execute("SELECT * FROM recommendations")
# rows = cursor.fetchall()
# df2 = pd.DataFrame(rows, columns=['brand', 'name', 'price', 'url', 'img', 'skin type', 'concern', 'label'])

# close cursor and database connection
# cursor.close()
# conn.close()

df2 = pd.read_csv('/Users/kavyashrivastava/PycharmProjects/skintelligence-ml/models/recommender/final.csv')
# features
entries = len(df2)
...
# continue with the rest of the code, using df2 as the dataframe for the products
